...
export const q0: Question = {
  ...
  options: [
    ...
    option("C", "我的月经暂时不来（怀孕、哺乳、药物、压力、进食障碍、主动使用皮下埋植技术等）", null, null, ["GAP"]),
    option("D", "我曾经来过月经，现在不来了（处于围绝经期/已绝经/因为手术而停止来月经）", null, null, ["GRAD"]),
...
export const formalQuestions: Question[] = [
  ...
  {
    id: "E4",
    title: "经期你的“美食信号”和“身体欲望信号”是什么？",
    type: "formal",
    dimension: "E",
    options: [
      option("A", "两盏全灭：什么都不想吃，也不想肢体接触", 0, "E"),
      option("B", "只有食欲亮红灯：特别馋某类食物，亲密信号灯完全黑着", 1, "E"),
      option("C", "两盏都是黄灯：和平时差不多，不急不躁", 2, "E"),
      option("D", "两盏绿灯：食欲好，亲密信号也亮着，欢迎贴贴", 3, "E")
    ]
  },
  {
    id: "R1",
